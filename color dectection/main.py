...
root=Tk()
root.title("ColorDetector")
root.geometry("800x470+100+100")
root.configure(bg="#08426e")
...
def showimage():
    ...
    title="Select Image Files",filetype=(('JPG file','*.jpg'),('PNG file','*.png'),('ALL file','*')))
...
Label(root,width=120,height=10,bg="#f02e2e").pack()
...
hex10=Label(colors2,text="#14aafs",fg="#000",font="arial 12 bold",bg="white")
...
#select image
selectimage=Frame(frame,width=340,height=350,bg="#6f7375")
